...
Provisum ships with 9 pre-built demo environments covering different ERP migration scenarios. Each environment includes realistic users, roles, permissions, SOD rules, and role assignments.

## Usage

```bash
# Default pack (SAP ECC → S/4HANA, 10K users)
pnpm db:seed
...
|------|-------------|--------------|-------|-------------|-------------|-------------|-------------|-----------|-------|
| `default` | SAP ECC | S/4HANA | 10,000 | 21 | 104 | 18 | 33 | 82* | 14 |
| `energy-chemicals-s4hana` | SAP ECC | S/4HANA | 10,000 | 20 | 70 | 18 | 40 | 51* | 10 |
...
- **App users** are always created (11 test users with predefined roles and passwords)
